...
<xsl:result-document method="html" href="../public/c{$chapitre_page}m{$element_page}.html">
<xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html&gt;</xsl:text>
        <html>
            <head>
                ...
                <meta content="http://analysons-macron.fr/" property="og:url" />
                <meta content="Analyse détaillée, mesure par mesure, du programme de Macron. Par la France Insoumise." property="og:description" />
                <meta content="http://analysons-macron.fr/elements/c{$chapitre_page}m{$element_page}.png" property="og:image" />
